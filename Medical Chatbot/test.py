...
# # Load the tokenizer in chunks
tokenizer = AutoTokenizer.from_pretrained(
    "C:/Users/Alarab/Documents/New folder/Symptoms QA chatbot/lora_finetuned_model",
    use_fast=False,
...
if submit and input_text:
    ...
    # Rerun the app to update the chat with user input and "Analyzing..."
    st.experimental_rerun()

if st.session_state['bot_placeholder'] and st.session_state['bot_placeholder'][1] == '<div class="loading-icon"></div> Analyzing...':
# Get the response from the bot
    ...
    # Clear the placeholder and rerun to display the bot's response
